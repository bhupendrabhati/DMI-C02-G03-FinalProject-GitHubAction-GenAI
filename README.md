...
# 🐾 Spring PetClinic Microservices – Modern UI Redesign

A modernized version of the famous Spring PetClinic Microservices application built using Spring Boot, Spring Cloud, AngularJS, and enhanced with a beautiful custom UI redesign, chatbot integration, and DevOps-ready architecture.

✨ Project Highlights

✅ Modern responsive UI redesign
✅ Interactive pet showcase section
✅ Spring AI Chatbot integration
✅ Microservices architecture using Spring Cloud
✅ API Gateway & Eureka Discovery
✅ Docker & Kubernetes ready
✅ Monitoring support with Grafana & Prometheus
✅ AWS / DevOps deployment friendly

🚀 UI Enhancements Added

This project includes a complete custom redesign of the frontend interface:
...
This project consists of multiple Spring Boot microservices:

Service	Description
API Gateway	Routes all client requests
Discovery Server	Eureka service registry
Config Server	Centralized configuration
Customers Service	Owner & pet management
Vets Service	Veterinarian information
Visits Service	Appointment records
GenAI Service	AI Chatbot integration
🛠️ Technologies Used
Backend
Java 17
Spring Boot
...
## Clone Repository
git clone https://github.com/bhupendrabhati/DMI-C02-G03-FinalProject

## Enter into Directory
cd DMI-C02-G03-FinalProject

## Start Services
./mvnw spring-boot:run

## Open Application (if running in local machine)
http://localhost:8080
...
The application includes a Spring AI powered chatbot capable of:
...
## 👨‍💻 Author
Bhupendra Bhati
Cloud & DevOps Engineer | Java & Spring Boot Enthusiast

## ⭐ Credits
Original project inspired by the official Spring PetClinic Microservices application:
